@extends('layouts.app')
@section('title','Create Manufacture Template')
@section('style')
    <style>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{route('manufacture_template.create')}}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive-sm">
                                    <table class="table table-bordered table-custom-form" id="product-table">
                                        <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Loss Quantity(%) <span class="text-danger">*</span></th>
                                            <th></th>
                                        </tr>
                                        </thead>
                                                ...
                                                <tr class="product-item">
                                                    ...
                                                    <td>
                                                        <div class="form-group {{ $errors->has('unit_price.'.$loop->index) ? 'has-error' :'' }}">
                                                            <input readonly type="text" value="{{ old('unit_price.'.$loop->index) }}" name="unit_price[]" class="form-control unit_price">
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="form-group {{ $errors->has('loss_quantity_percent.'.$loop->index) ? 'has-error' :'' }}">
                                                            <input type="text" value="{{ old('loss_quantity_percent.'.$loop->index,0) }}" name="loss_quantity_percent[]" class="form-control loss_quantity_percent">
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                        ...
                                        @else
                                            <tr class="product-item">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" name="loss_quantity_percent[]" value="{{ old('loss_quantity_percent',0) }}" class="form-control loss_quantity_percent">
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <a role="button" style="display: none" class="btn btn-danger btn-sm btn-remove"><i class="fa fa-trash"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th> <input type="text" class="form-control extra_cost"  value="{{ old('extra_cost',0) }}" name="extra_cost"></th>
                                            <th></th>
                                            <th></th>
                                        </tr>
                                        <tr>
    ...
    <script>
        $(function (){
            ...
            $('body').on('change', '.product', function () {
                ...
                itemProduct.closest('tr').find('.unit_price').html('');
                if (productId != '') {
                    $.ajax({
                        method: "GET",
                        ...
                        itemProduct.closest('tr').find('.unit_name').html(response.product.unit.name);
            ...
            $('body').on('keyup', '.quantity, .extra_cost, .unit_price', function () {
                calculate();
            });
            calculate();
        });
        function calculate() {
            ...
            $('#product-table .product-item').each(function (i, obj) {
                var quantity = parseFloat($('.quantity:eq(' + i + ')').val());
            ...
            // Format the totalUnitPrice to show the result properly
