                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="submit" name="search"
                                           class="btn btn-dark bg-gradient-dark form-control" value="Search">
                                </div>
                            </div>
                        </div>
                    </form>
...
{{--                                    <img height="50px" src="{{ asset('img/logo.png') }}" alt="">--}}
                                ...
                                <h3 class="text-center m-0" style="font-size: 25px !important;">Consumption Report</h3>
                                ...
                                <table id="table" class="table table-bordered">
                                    ...
                                    @foreach($rowMaterials as $rowMaterial)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($rowMaterial->consumption_quantity * $rowMaterial->consumption_unit_price,2) }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($rowMaterials->sum('consumption_quantity'),2) }}</td>
                                            <td class="text-right"></td>
                                            <td class="text-right">{{ number_format($totalConsumptionValue,2) }}</td>
                                            <td class="text-right"></td>
                                            <td class="text-right">{{ number_format($rowMaterials->sum('consumption_loss_quantity'),2) }}</td>
