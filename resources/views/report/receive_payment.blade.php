                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" id="start" autocomplete="off" required
                                               name="start" class="form-control date-picker"
                                               placeholder="Enter Start Date"
                                               value="{{ request()->get('start')  ?? date('d-m-Y')  }}">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" id="end" autocomplete="off" required
                                               name="end" class="form-control date-picker"
                                               placeholder="Enter Start Date"
                                               value="{{ request()->get('end') ?? date('d-m-Y')  }}">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div style="padding:10px; width:100%; text-align:center;">
                                <div class="row ">
                                    <div class="col-12 text-center" style="margin-top: 25px">
                                        <img height="90px" width="55%" src="{{ asset('img/logo.png') }}" alt="">
                                    </div>
                                    <div class="col-12">
                                        <h3 class="text-center m-0" style="font-size: 25px !important;">Receive And Payment Report</h3>
