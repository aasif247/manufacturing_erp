@extends('layouts.app')
@section('title','Purchase Return Receipt')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('purchase.return') }}" class="btn btn-primary bg-gradient-primary">Add Return</a>
                </div>
                <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Purchase Return Receipt Information</h4>
    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('purchase_return_receipt.datatable') }}',
                columns: [
            ...
            $('#modal-btn-pay').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('purchase_return_payment') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
